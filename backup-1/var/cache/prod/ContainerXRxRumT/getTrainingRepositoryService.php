...
// Returns the private 'App\Repository\TrainingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrainingRepository.php';

return $this->privates['App\Repository\TrainingRepository'] = new \App\Repository\TrainingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
