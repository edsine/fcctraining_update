...
// Returns the private 'App\Repository\MdaParticipantRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MdaParticipantRepository.php';

return $this->privates['App\Repository\MdaParticipantRepository'] = new \App\Repository\MdaParticipantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
