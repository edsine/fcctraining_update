...
// Returns the private 'App\Repository\FinancialsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FinancialsRepository.php';

return $this->privates['App\Repository\FinancialsRepository'] = new \App\Repository\FinancialsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
