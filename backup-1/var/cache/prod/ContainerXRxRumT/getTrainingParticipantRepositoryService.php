...
// Returns the private 'App\Repository\TrainingParticipantRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrainingParticipantRepository.php';

return $this->privates['App\Repository\TrainingParticipantRepository'] = new \App\Repository\TrainingParticipantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
