...
// Returns the private 'App\Repository\TrainingSessionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TrainingSessionRepository.php';

return $this->privates['App\Repository\TrainingSessionRepository'] = new \App\Repository\TrainingSessionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
