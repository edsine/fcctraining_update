...
$d->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\FinancialsRepository' => function () {
    return ($this->privates['App\Repository\FinancialsRepository'] ?? $this->load(__DIR__.'/getFinancialsRepositoryService.php'));
}, 'App\\Repository\\InvoiceRepository' => function () {
    return ($this->privates['App\Repository\InvoiceRepository'] ?? $this->load(__DIR__.'/getInvoiceRepositoryService.php'));
}, 'App\\Repository\\MdaParticipantRepository' => function () {
    return ($this->privates['App\Repository\MdaParticipantRepository'] ?? $this->load(__DIR__.'/getMdaParticipantRepositoryService.php'));
}, 'App\\Repository\\MdaRepository' => function () {
    return ($this->privates['App\Repository\MdaRepository'] ?? $this->load(__DIR__.'/getMdaRepositoryService.php'));
}, 'App\\Repository\\TrainingParticipantRepository' => function () {
    return ($this->privates['App\Repository\TrainingParticipantRepository'] ?? $this->load(__DIR__.'/getTrainingParticipantRepositoryService.php'));
}, 'App\\Repository\\TrainingRepository' => function () {
    return ($this->privates['App\Repository\TrainingRepository'] ?? $this->load(__DIR__.'/getTrainingRepositoryService.php'));
}, 'App\\Repository\\TrainingSessionRepository' => function () {
    return ($this->privates['App\Repository\TrainingSessionRepository'] ?? $this->load(__DIR__.'/getTrainingSessionRepositoryService.php'));
